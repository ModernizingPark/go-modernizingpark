...
var (
	...
	// and accepted by the Modernizingpark core developers into the Ethash consensus.
	//
	...
	// and accepted by the Modernizingpark core developers into the Clique consensus.
	//
	// This configuration is intentionally not using keyed fields to force anyone
	// adding flags to the config to also have to set these fields.
...
type ChainConfig struct {
	...
	// EIP150 implements the Gas price changes (https://github.com/modernizingpark/EIPs/issues/150)
	...
	YoloV1Block *big.Int `json:"yoloV1Block,omitempty"` // YOLO v1: https://github.com/modernizingpark/EIPs/pull/2657 (Ephemeral testnet)
...
// CheckConfigForkOrder checks that we don't "skip" any forks, gmpc isn't pluggable enough
