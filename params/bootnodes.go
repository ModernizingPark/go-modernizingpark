...
import "github.com/modernizingpark/go-modernizingpark/common"

// MainnetBootnodes are the enode URLs of the P2P bootstrap nodes running on
// the main Modernizingpark network.
var MainnetBootnodes = []string{
	// Modernizingpark Foundation Go Bootnodes
...
// genesis hash and protocol. See https://github.com/modernizingpark/discv4-dns-lists for more
// information.
