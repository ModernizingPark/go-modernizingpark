...
func TestNewUnpacker(t *testing.T) {
	...
	testcases := []unpackTest{
		...
		}, { // https://github.com/modernizingpark/wiki/wiki/Modernizingpark-Contract-ABI#examples
...
[
	...
	for i, hexdata := range []string{
		...
		// From https://github.com/modernizingpark/wiki/wiki/Modernizingpark-Contract-ABI
