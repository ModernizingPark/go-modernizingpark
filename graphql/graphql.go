...
// Package graphql provides a GraphQL interface to Modernizingpark node data.
package graphql
...
// Account represents an Modernizingpark account at a particular block.
type Account struct {
...
// Transaction represents an Modernizingpark transaction.
...
// Block represents an Modernizingpark block.
...
type CallData struct {
	From     *common.Address // The Modernizingpark address the call is from.
	To       *common.Address // The Modernizingpark address the call is to.
...
type SyncState struct {
	progress modernizingpark.SyncProgress
}
