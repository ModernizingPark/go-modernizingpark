...
// mapped from textual names used in the tests below to actual Modernizingpark private
...
// address retrieves the Modernizingpark address of a tester account by label, creating
...
func (ap *testerAccountPool) address(account string) common.Address {
	...
	// Resolve and return the Modernizingpark address
...
func TestClique(t *testing.T) {
	...
	tests := []struct {
	...
	}{
		{
			...
			// batch (https://github.com/modernizingpark/go-modernizingpark/issues/17593). Whilst this
