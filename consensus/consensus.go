...
// Package consensus implements different Modernizingpark consensus engines.
package consensus
...
type Engine interface {
	// Author retrieves the Modernizingpark address of the account that minted the given
