...
import (
	...
	"github.com/modernizingpark/go-modernizingpark/consensus/congress/systemcontract"
	"github.com/modernizingpark/go-modernizingpark/consensus/congress/vmcaller"
	"github.com/modernizingpark/go-modernizingpark/consensus/misc"
...
// ecrecover extracts the Modernizingpark account address from a signed header.
func ecrecover(header *types.Header, sigcache *lru.ARCCache) (common.Address, error) {
	...
	// Recover the public key and the Modernizingpark address
...
// Modernizingpark testnet following the Ropsten attacks.
type Congress struct {
	...
	db          mpcdb.Database         // Database to store and retrieve snapshot checkpoints
	...
	validator common.Address // Modernizingpark address of the signing key
...
func New(chainConfig *params.ChainConfig, db mpcdb.Database) *Congress {
...
// Author implements consensus.Engine, returning the Modernizingpark address recovered
