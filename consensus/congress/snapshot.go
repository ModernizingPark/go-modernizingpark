...
func loadSnapshot(config *params.CongressConfig, sigcache *lru.ARCCache, db mpcdb.Database, hash common.Hash) (*Snapshot, error) {
...
func (s *Snapshot) store(db mpcdb.Database) error {
