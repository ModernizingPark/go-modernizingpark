...
// This test reproduces https://github.com/modernizingpark/go-modernizingpark/issues/17837 where the
...
func ipcTestClient(srv *Server, fl *flakeyListener) (*Client, net.Listener) {
	...
	endpoint := fmt.Sprintf("go-modernizingpark-test-ipc-%d-%d", os.Getpid(), rand.Int63())
