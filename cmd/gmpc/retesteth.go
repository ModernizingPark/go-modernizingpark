...
var (
	...
	retestethCommand = cli.Command{
		...
		Name:        "retesteth",
		Usage:       "Launches gmpc in retesteth mode",
		ArgsUsage:   "",
		Flags:       []cli.Flag{rpcPortFlag},
		Category:    "MISCELLANEOUS COMMANDS",
		Description: `Launches gmpc in retesteth mode (no database, no network, only retesteth RPC interface)`,
	}
)
...
func (api *RetestethAPI) ClientVersion(ctx context.Context) (string, error) {
	return "Gmpc-" + params.VersionWithCommit(gitCommit, gitDate), nil
}
