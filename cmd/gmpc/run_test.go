...
import (
	...
	"github.com/modernizingpark/go-modernizingpark/internal/cmdtest"
	"github.com/modernizingpark/go-modernizingpark/rpc"
)

func tmpdir(t *testing.T) string {
	dir, err := ioutil.TempDir("", "gmpc-test")
	if err != nil {
		t.Fatal(err)
	}
	return dir
...
func init() {
	// Run the app if we've been exec'd as "gmpc-test" in runGeth.
	reexec.Register("gmpc-test", func() {
...
// spawns gmpc with the given command line args. If the args don't set --datadir, the
...
func runGeth(t *testing.T, args ...string) *testgeth {
	...
	// Boot "gmpc". This actually runs the test binary but the TestMain
	// function will prevent any tests from running.
	tt.Run("gmpc-test", args...)
