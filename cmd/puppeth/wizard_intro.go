...
// setting up a new or managing an existing Modernizingpark private network.
func (w *wizard) run() {
	fmt.Println("+-----------------------------------------------------------+")
	fmt.Println("| Welcome to puppeth, your Modernizingpark private network manager |")
	fmt.Println("|                                                           |")
	fmt.Println("| This tool lets you create a new Modernizingpark network down to  |")
	fmt.Println("| the genesis block, bootnodes, miners and mpcstats servers |")
	...
	log.Info("Administering Modernizingpark network", "name", w.network)
