...
// importGenesis imports a Gmpc genesis spec into puppeth.
...
func (w *wizard) manageGenesis() {
	...
	case "2":
		...
		// Export the native genesis spec used by puppeth and Gmpc
		...
		// Export the genesis spec used by Aleth (formerly C++ Modernizingpark)
