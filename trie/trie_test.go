...
func (s *spongeDb) NewBatch() mpcdb.Batch                    { return &spongeBatch{s} }
...
func (s *spongeDb) NewIterator(prefix []byte, start []byte) mpcdb.Iterator { panic("implement me") }
...
func (b *spongeBatch) Replay(w mpcdb.KeyValueWriter) error { return nil }
