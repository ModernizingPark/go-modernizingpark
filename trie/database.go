...
type Database struct {
	diskdb mpcdb.KeyValueStore // Persistent storage for matured trie nodes
...
func NewDatabase(diskdb mpcdb.KeyValueStore) *Database {
...
func NewDatabaseWithCache(diskdb mpcdb.KeyValueStore, cache int, journal string) *Database {
...
func (db *Database) DiskDB() mpcdb.KeyValueStore {
	return db.diskdb
}
...
func (db *Database) commit(hash common.Hash, batch mpcdb.Batch, uncacher *cleaner, callback func(common.Hash)) error {
