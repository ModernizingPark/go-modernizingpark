...
// source: messages-modernizingpark.proto
...
//*
// Request: Ask device for Modernizingpark address corresponding to address_n path
// @start
...
//*
// Response: Contains an Modernizingpark address derived from device private seed
// @end
