...
// the `coin_type` 60' (or 0x8000003C) to Modernizingpark.
//
// The root path for Modernizingpark is m/44'/60'/0'/0 according to the specification
// from https://github.com/modernizingpark/EIPs/issues/84, albeit it's not set in stone
