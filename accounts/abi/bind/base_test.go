...
func (mc *mockCaller) CallContract(ctx context.Context, call modernizingpark.CallMsg, blockNumber *big.Int) ([]byte, error) {
...
func (mc *mockCaller) PendingCallContract(ctx context.Context, call modernizingpark.CallMsg) ([]byte, error) {
