...
// Package bind generates Modernizingpark contract Go bindings.
//
// Detailed usage document and tutorial available on the go-modernizingpark Wiki page:
// https://github.com/modernizingpark/go-modernizingpark/wiki/Native-DApps:-Go-bindings-to-Modernizingpark-contracts
package bind
