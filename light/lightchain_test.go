...
func makeHeaderChain(parent *types.Header, n int, db mpcdb.Database, seed int) []*types.Header {
...
// header only chain.
func newCanonical(n int) (mpcdb.Database, *LightChain, error) {
...
func (odr *dummyOdr) Database() mpcdb.Database {
	return odr.db
}
