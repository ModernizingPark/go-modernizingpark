...
// Contains all the wrappers from the go-modernizingpark root package.
...
type Subscription struct {
	sub modernizingpark.Subscription
}
...
type FilterQuery struct {
	query modernizingpark.FilterQuery
}
