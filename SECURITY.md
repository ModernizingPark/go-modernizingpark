...
Audit reports are published in the `docs` folder: https://github.com/modernizingpark/go-modernizingpark/tree/master/docs/audits


| Scope | Date | Report Link |
| ------- | ------- | ----------- |
| `gmpc` | 20170425 | [pdf](https://github.com/modernizingpark/go-modernizingpark/blob/master/docs/audits/2017-04-25_Geth-audit_Truesec.pdf) |
| `clef` | 20180914 | [pdf](https://github.com/modernizingpark/go-modernizingpark/blob/master/docs/audits/2018-09-14_Clef-audit_NCC.pdf) |
...
To find out how to disclose a vulnerability in Modernizingpark visit [https://bounty.modernizingpark.org](https://bounty.modernizingpark.org) or email bounty@modernizingpark.org.
