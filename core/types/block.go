...
// Package types contains data types related to Modernizingpark consensus.
package types
...
// Header represents a block header in the Modernizingpark blockchain.
type Header struct {
...
// Block represents an entire block in the Modernizingpark blockchain.
type Block struct {
	header       *Header
	uncles       []*Header
...
// DecodeRLP decodes the Modernizingpark
...
// EncodeRLP serializes b into the Modernizingpark RLP block format.
