...
func wipeSnapshot(db mpcdb.KeyValueStore, full bool) chan struct{} {
...
func wipeContent(db mpcdb.KeyValueStore) error {
...
func wipeKeyRange(db mpcdb.KeyValueStore, kind string, prefix []byte, keylen int) error {
