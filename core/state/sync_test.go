...
// account array.
func checkStateAccounts(t *testing.T, db mpcdb.Database, root common.Hash, accounts []*testAccount) {
...
func checkTrieConsistency(db mpcdb.Database, root common.Hash) error {
...
func checkStateConsistency(db mpcdb.Database, root common.Hash) error {
...
func TestIncompleteStateSync(t *testing.T) {
	...
	checkTrieConsistency(srcDb.TrieDB().DiskDB().(mpcdb.Database), srcRoot)
