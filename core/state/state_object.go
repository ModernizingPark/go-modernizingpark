...
// stateObject represents an Modernizingpark account which is being modified.
//
...
type stateObject struct {
	...
	addrHash common.Hash // hash of modernizingpark address of the account
	data     Account
	db       *StateDB
...
// Account is the Modernizingpark consensus representation of accounts.
