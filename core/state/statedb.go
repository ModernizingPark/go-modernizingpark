...
// Package state provides a caching layer atop the Modernizingpark state trie.
package state
...
// StateDB structs within the modernizingpark protocol are used to store anything
...
func (s *StateDB) Copy() *StateDB {
	...
	for addr := range s.journal.dirties {
		// As documented [here](https://github.com/modernizingpark/go-modernizingpark/pull/16485#issuecomment-380438527),
