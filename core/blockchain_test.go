...
// header only chain.
func newCanonical(engine consensus.Engine, n int, full bool) (mpcdb.Database, *BlockChain, error) {
	var (
...
func TestLightVsFastVsFullChainHeads(t *testing.T) {
	...
	makeDb := func() (mpcdb.Database, func()) {
...
//
// https://github.com/modernizingpark/go-modernizingpark/pull/15941
...
//
// Details at:
//  - https://github.com/modernizingpark/go-modernizingpark/issues/18977
//  - https://github.com/modernizingpark/go-modernizingpark/pull/18988
