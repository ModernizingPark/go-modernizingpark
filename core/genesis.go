...
func SetupGenesisBlock(db mpcdb.Database, genesis *Genesis) (*params.ChainConfig, common.Hash, error) {
...
func (g *Genesis) ToBlock(db mpcdb.Database) *types.Block {
	if db == nil {
...
func (g *Genesis) Commit(db mpcdb.Database) (*types.Block, error) {
	block := g.ToBlock(db)
...
// The block is committed as the canonical head block.
func (g *Genesis) MustCommit(db mpcdb.Database) *types.Block {
...
func GenesisBlockForTesting(db mpcdb.Database, addr common.Address, balance *big.Int) *types.Block {
	g := Genesis{Alloc: GenesisAlloc{addr: {Balance: balance}}}
	return g.MustCommit(db)
}

// DefaultGenesisBlock returns the Modernizingpark main net genesis block.
...
// DeveloperGenesisBlock returns the 'gmpc --dev' genesis block.
