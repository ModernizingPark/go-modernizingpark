...
import (
	...
	"github.com/modernizingpark/go-modernizingpark/mpcdb/leveldb"
...
func NewDatabase(db mpcdb.KeyValueStore) mpcdb.Database {
	return &nofreezedb{
		KeyValueStore: db,
	}
}
...
// storage.
func NewDatabaseWithFreezer(db mpcdb.KeyValueStore, freezer string, namespace string) (mpcdb.Database, error) {
...
func NewMemoryDatabase() mpcdb.Database {
...
func NewMemoryDatabaseWithCap(size int) mpcdb.Database {
	return NewDatabase(memorydb.NewWithCap(size))
}

// NewLevelDBDatabase creates a persistent key-value database without a freezer
// moving immutable chain segments into cold storage.
func NewLevelDBDatabase(file string, cache int, handles int, namespace string) (mpcdb.Database, error) {
...
// freezer moving immutable chain segments into cold storage.
func NewLevelDBDatabaseWithFreezer(file string, cache int, handles int, freezer string, namespace string) (mpcdb.Database, error) {
...
func InspectDatabase(db mpcdb.Database) error {
