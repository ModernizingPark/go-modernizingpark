...
//   reserving it for go-modernizingpark. This would also reduce the memory requirements
//   of Gmpc, and thus also GC overhead.
type freezer struct {
...
func (f *freezer) freeze(db mpcdb.KeyValueStore) {
