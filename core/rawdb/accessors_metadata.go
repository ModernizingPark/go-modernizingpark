...
func ReadDatabaseVersion(db mpcdb.KeyValueReader) *uint64 {
	var version uint64
...
func WriteDatabaseVersion(db mpcdb.KeyValueWriter, version uint64) {
...
func ReadChainConfig(db mpcdb.KeyValueReader, hash common.Hash) *params.ChainConfig {
...
func WriteChainConfig(db mpcdb.KeyValueWriter, hash common.Hash, cfg *params.ChainConfig) {
	if cfg == nil {
		return
	}
