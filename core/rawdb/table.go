...
func NewTable(db mpcdb.Database, prefix string) mpcdb.Database {
	return &table{
		db:     db,
		prefix: prefix,
	}
...
func (t *table) NewIterator(prefix []byte, start []byte) mpcdb.Iterator {
...
func (t *table) NewBatch() mpcdb.Batch {
...
func (b *tableBatch) Replay(w mpcdb.KeyValueWriter) error {
