...
// Package forkid implements EIP-2124 (https://eips.modernizingpark.org/EIPS/eip-2124).
package forkid
...
// NewID calculates the Modernizingpark fork ID from the chain config, genesis hash, and head.
