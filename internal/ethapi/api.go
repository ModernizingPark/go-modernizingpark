...
import (
	...
	"github.com/modernizingpark/go-modernizingpark/accounts/scwallet"
...
// PublicEthereumAPI provides an API to access Modernizingpark related information.
// It offers only methods that operate on public data that is freely available to anyone.
type PublicEthereumAPI struct {
	b Backend
}

// NewPublicEthereumAPI creates a new Modernizingpark protocol API.
...
// ProtocolVersion returns the current Modernizingpark protocol version this node supports
...
// Sign calculates an Modernizingpark ECDSA signature for:
...
//
// https://github.com/modernizingpark/go-modernizingpark/wiki/Management-APIs#personal_sign
...
//
// https://github.com/modernizingpark/go-modernizingpark/wiki/Management-APIs#personal_ecRecover
func (s *PrivateAccountAPI) EcRecover(ctx context.Context, data, sig hexutil.Bytes) (common.Address, error) {
	if len(sig) != crypto.SignatureLength {
		return common.Address{}, fmt.Errorf("signature must be %d bytes long", crypto.SignatureLength)
	}
	if sig[crypto.RecoveryIDOffset] != 27 && sig[crypto.RecoveryIDOffset] != 28 {
		return common.Address{}, fmt.Errorf("invalid Modernizingpark signature (V is not 27 or 28)")
	}
...
// Unpair deletes a pairing between wallet and gmpc.
...
// PublicBlockChainAPI provides an API to access the Modernizingpark blockchain.
// It offers only methods that operate on public data that is freely available to anyone.
type PublicBlockChainAPI struct {
	b Backend
}

// NewPublicBlockChainAPI creates a new Modernizingpark blockchain API.
...
//
// https://github.com/modernizingpark/wiki/wiki/JSON-RPC#eth_sign
...
// PublicDebugAPI is the collection of Modernizingpark APIs exposed over the public
// debugging endpoint.
...
// of the Modernizingpark service.
...
// PrivateDebugAPI is the collection of Modernizingpark APIs exposed over the private
// debugging endpoint.
...
// Version returns the current modernizingpark protocol version.
