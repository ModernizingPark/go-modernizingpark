...
// Package filters implements an modernizingpark filtering system for block,
...
type subscription struct {
	...
	typ       Type
	created   time.Time
	logsCrit  modernizingpark.FilterQuery
	logs      chan []*types.Log
...
func (es *EventSystem) SubscribeLogs(crit modernizingpark.FilterQuery, logs chan []*types.Log) (*Subscription, error) {
...
func (es *EventSystem) subscribeMinedPendingLogs(crit modernizingpark.FilterQuery, logs chan []*types.Log) *Subscription {
	sub := &subscription{
		id:        rpc.NewID(),
...
func (es *EventSystem) subscribeLogs(crit modernizingpark.FilterQuery, logs chan []*types.Log) *Subscription {
	sub := &subscription{
		id:        rpc.NewID(),
...
func (es *EventSystem) subscribePendingLogs(crit modernizingpark.FilterQuery, logs chan []*types.Log) *Subscription {
	sub := &subscription{
		id:        rpc.NewID(),
