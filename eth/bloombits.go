...
const (
	// bloomServiceThreads is the number of goroutines used globally by an Modernizingpark
...
func (eth *Modernizingpark) startBloomHandlers(sectionSize uint64) {
...
// for the Modernizingpark header bloom filters, permitting blazing fast filtering.
type BloomIndexer struct {
	size    uint64               // section size to generate bloombits for
	db      mpcdb.Database       // database instance to write index data and metadata into
...
func NewBloomIndexer(db mpcdb.Database, size, confirms uint64) *core.ChainIndexer {
