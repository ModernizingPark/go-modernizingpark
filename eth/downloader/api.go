...
// Syncing provides information when this nodes starts synchronising with the Modernizingpark network and when it's finished.
...
type SyncingResult struct {
	...
	Status  modernizingpark.SyncProgress `json:"status"`
}
