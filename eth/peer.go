...
// PeerInfo represents a short summary of the Modernizingpark sub-protocol metadata known
// about a connected peer.
type PeerInfo struct {
	Version    int      `json:"version"`    // Modernizingpark protocol version negotiated
...
// the Modernizingpark sub-protocol.
type peerSet struct {
