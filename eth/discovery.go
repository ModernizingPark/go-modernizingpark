...
func (eth *Modernizingpark) startEthEntryUpdate(ln *enode.LocalNode) {
...
func (eth *Modernizingpark) currentEthEntry() *ethEntry {
...
func (eth *Modernizingpark) setupDiscovery(cfg *p2p.Config) (enode.Iterator, error) {
