...
import (
	...
	"github.com/modernizingpark/go-modernizingpark/eth/tracers/internal/tracers"
)
...
// init retrieves the JavaScript transaction tracers included in go-modernizingpark.
func init() {
