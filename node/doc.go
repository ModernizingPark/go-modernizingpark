...
/*
Package node sets up multi-protocol Modernizingpark nodes.
...
Node also creates the shared store of encrypted Modernizingpark account keys. Services can access
