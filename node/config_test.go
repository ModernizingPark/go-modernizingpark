...
func TestIPCPathResolution(t *testing.T) {
	var tests = []struct {
		...
		{"", "", false, ""},
		{"data", "", false, ""},
		{"", "gmpc.ipc", false, filepath.Join(os.TempDir(), "gmpc.ipc")},
		{"data", "gmpc.ipc", false, "data/gmpc.ipc"},
		{"data", "./gmpc.ipc", false, "./gmpc.ipc"},
		{"data", "/gmpc.ipc", false, "/gmpc.ipc"},
		{"", "", true, ``},
		{"data", "", true, ``},
		{"", "gmpc.ipc", true, `\\.\pipe\geth.ipc`},
		{"data", "gmpc.ipc", true, `\\.\pipe\geth.ipc`},
