...
func makeMiner(genesis *core.Genesis) (*node.Node, *eth.Modernizingpark, error) {
	// Define the basic configurations for the Modernizingpark node
	...
	// Create the node and configure a full Modernizingpark node on it
