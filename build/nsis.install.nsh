Name "gmpc ${MAJORVERSION}.${MINORVERSION}.${BUILDVERSION}" # VERSION variables set through command line arguments
InstallDir "$InstDir"
OutFile "${OUTPUTFILE}" # set through command line arguments

# Links for "Add/Remove Programs"
!define HELPURL "https://github.com/modernizingpark/go-modernizingpark/issues"
!define UPDATEURL "https://github.com/modernizingpark/go-modernizingpark/releases"
!define ABOUTURL "https://github.com/modernizingpark/go-modernizingpark#modernizingpark-go"
...
Section "Gmpc" GETH_IDX
  ...
  SimpleFC::AdvRemoveRule "Gmpc incoming peers (TCP:30303)"
  SimpleFC::AdvRemoveRule "Gmpc outgoing peers (TCP:30303)"
  SimpleFC::AdvRemoveRule "Gmpc UDP discovery (UDP:30303)"

  # Firewall - add rules
  SimpleFC::AdvAddRule "Gmpc incoming peers (TCP:30303)" ""  6 1 1 2147483647 1 "$INSTDIR\geth.exe" "" "" "Modernizingpark" 30303 "" "" ""
  SimpleFC::AdvAddRule "Gmpc outgoing peers (TCP:30303)" ""  6 2 1 2147483647 1 "$INSTDIR\geth.exe" "" "" "Modernizingpark" "" 30303 "" ""
  SimpleFC::AdvAddRule "Gmpc UDP discovery (UDP:30303)" "" 17 2 1 2147483647 1 "$INSTDIR\geth.exe" "" "" "Modernizingpark" "" 30303 "" ""

  # Set default IPC endpoint (https://github.com/modernizingpark/EIPs/issues/147)
