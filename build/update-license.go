...
var (
	...
	skipPrefixes = []string{
		...
		"crypto/secp256k1", // Relicensed to BSD-3 via https://github.com/modernizingpark/go-modernizingpark/pull/17225
	}
	...
	authorsFileHeader = "# This is the official list of go-modernizingpark authors for copyright purposes.\n\n"
)

// this template generates the license comment.
// its input is an info structure.
var licenseT = template.Must(template.New("").Parse(`
// Copyright {{.Year}} The go-modernizingpark Authors
...
func (i info) Whole(startOfSentence bool) string {
	if i.gpl() {
		return "go-modernizingpark"
	}
	if startOfSentence {
		return "The go-modernizingpark library"
	}
	return "the go-modernizingpark library"
}
