...
# 1. install gmpc for all users
# 2. install optional development tools such as abigen
# 3. create an uninstaller
# 4. configures the Windows firewall for gmpc
# 5. create gmpc, attach and uninstall start menu entries
...
!define GROUPNAME "Modernizingpark"
!define APPNAME "Gmpc"
!define DESCRIPTION "Official Go implementation of the Modernizingpark protocol"
!addplugindir .\
...
function .onInit
  # make vars are global for all users since gmpc is installed global
