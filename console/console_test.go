...
import (
	...
	"github.com/modernizingpark/go-modernizingpark/internal/jsre"
...
type tester struct {
	workspace string
	stack     *node.Node
	modernizingpark  *eth.Modernizingpark
	console   *Console
...
func newTester(t *testing.T, confOverride func(*eth.Config)) *tester {
	...
	// Create a networkless protocol stack and start an Modernizingpark service within
	...
	if err != nil {
		t.Fatalf("failed to register Modernizingpark protocol: %v", err)
	}
