...
import (
	...
	"github.com/modernizingpark/go-modernizingpark/internal/jsre/deps"
	"github.com/modernizingpark/go-modernizingpark/internal/web3ext"
...
type Config struct {
	...
	Client   *rpc.Client         // RPC client to execute Modernizingpark requests through
...
// Welcome show summary of current Gmpc instance and some metadata about the
// console's available modules.
func (c *Console) Welcome() {
	message := "Welcome to the Gmpc JavaScript console!\n\n"

	// Print some generic Gmpc metadata
