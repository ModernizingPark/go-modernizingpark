...
import (
	...
	"github.com/modernizingpark/go-modernizingpark/p2p/simulations"
	"github.com/modernizingpark/go-modernizingpark/p2p/simulations/adapters"
...
func newLesServerService(ctx *adapters.ServiceContext, stack *node.Node) (node.Lifecycle, error) {
	...
	modernizingpark, err := eth.New(stack, &config)
	if err != nil {
		return nil, err
	}
	_, err = NewLesServer(stack, modernizingpark, &config)
	if err != nil {
		return nil, err
	}
	return modernizingpark, nil
}
