 ...
 * @author Gary Rong<garyrong@modernizingpark.org>, Martin Swende <martin.swende@modernizingpark.org>
...
contract CheckpointOracle {
    ...
    */
    ...
    //
    // The default value should be the same as the checkpoint size(32768) in the modernizingpark.
    uint sectionSize;
